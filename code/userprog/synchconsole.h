...
class SynchConsoleInput : public CallBackObj {
  public:
    ...
    char GetChar();                     // Read a character, waiting if 
                                        // necessary
  private:
    ...
    void CallBack();                    // called when a keystroke is 
                                        // available
};
...
class SynchConsoleOutput : public CallBackObj {
  public:
    ...
    void PutChar(char ch);              // Write a character, waiting if 
                                        // necessary
  ...
  private:
    ...
    void CallBack();                    // called when more data can be 
                                        // written
};
