...
//      Initialize a bitmap with "numItems" bits, so that every bit is 
//      clear. It can be added somewhere on a list.
//
...
//
//      "numItems" -- the number of bits in the bitmap.
//      "file" -- an open file containing the bitmap (written
...
//
//      "file" -- the place to read the bitmap from
//----------------------------------------------------------------------
