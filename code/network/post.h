...
class PostOfficeInput : public CallBackObj {
  public:
    ...
    // CHANGE:
    // added following static member function to pass PostalDelivery
    // in Fork call in constructor, nnoc, 10/1/2001
    static void PostalDelivery_st(PostOfficeInput *poi);        
