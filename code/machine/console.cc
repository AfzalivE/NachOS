...
//      "toCall" -- the interrupt handler to call when a character arrives
//                  from the keyboard
//----------------------------------------------------------------------
...
//      Initialize the simulation of the output for a hardware console 
//      device.
//
//      "writeFile" -- UNIX file simulating the display (NULL -> use stdout)
//      "toCall" -- the interrupt handler to call when a write to 
