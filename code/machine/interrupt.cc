...
static char *intTypeNames[] = { "timer", 
                                "disk", 
                                "console write", 
                                "console read", 
                                "network send", 
...
//
//      "callOnInt" -- the object to call when the interrupt occurs
//      "time" -- when (in simulated time) the interrupt is to occur
//      "kind" -- the hardware device that generated the interrupt
//----------------------------------------------------------------------
